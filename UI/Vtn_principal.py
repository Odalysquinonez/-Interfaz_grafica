...
class Ui_VTNWindow(object):
    def setupUi(self, VTNWindow):
        ...
        self.lbl_tipo_persona.setGeometry(QRect(30, 10, 81, 21))
        ...
        self.mnb_menu_principal.setGeometry(QRect(0, 0, 340, 21))
    ...
    def retranslateUi(self, VTNWindow):
        ...
        self.lbl_tipo_persona.setText(QCoreApplication.translate("VTNWindow", u"tipo", None))
    # retranslateUi
